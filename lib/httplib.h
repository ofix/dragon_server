...
inline bool Server::parse_request_line(const char* s, Request& req) const {
    ...
    static const std::set<std::string> methods{"GET",    "HEAD",    "POST",    "PUT",
...
inline bool Server::write_content_with_provider(Stream& strm,
    ...
    if (res.content_length_ > 0) {
        if (req.ranges.empty()) {
            ...
            return detail::write_multipart_ranges_data(strm, req, res, boundary,
                                                       content_type, res.content_length_,
                                                       is_shutting_down);
        }
    } else {
...
inline bool Server::read_content_with_content_receiver(
    ...
    return read_content_core(strm, req, res, std::move(receiver),
                             std::move(multipart_header), std::move(multipart_receiver));
}
...
inline bool Server::read_content_core(Stream& strm,
    ...
    if (!detail::read_content(strm, req, payload_max_length_, res.status, nullptr, out,
                              true)) {
        return false;
    }
...
inline Result ClientImpl::Post(const std::string& path,
                               ...
                               const std::string& body,
                               const std::string& content_type) {
    return send_with_content_provider("POST", path, headers, body.data(), body.size(),
                                      nullptr, nullptr, content_type);
}
...
inline Result ClientImpl::Put(const std::string& path,
                              ...
                              const std::string& body,
                              const std::string& content_type) {
    return send_with_content_provider("PUT", path, headers, body.data(), body.size(),
                                      nullptr, nullptr, content_type);
}
...
inline Result ClientImpl::Patch(const std::string& path,
                                ...
                                size_t content_length,
                                const std::string& content_type) {
    return send_with_content_provider("PATCH", path, headers, body, content_length,
                                      nullptr, nullptr, content_type);
}
...
inline Result ClientImpl::Patch(const std::string& path,
                                ...
                                const std::string& body,
                                const std::string& content_type) {
    return send_with_content_provider("PATCH", path, headers, body.data(), body.size(),
                                      nullptr, nullptr, content_type);
}
